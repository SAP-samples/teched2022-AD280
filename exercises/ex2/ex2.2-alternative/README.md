...
1. Creating an SAPUI5 app from a template and preview it.
2. (Optional) Add an UI Element to the App View that shows intent based navigation within the Launchpad site. 

<br>

### Step 1: Create new Freestyle SAPUI5 Application from Template
